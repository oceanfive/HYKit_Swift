...
git_commit_des="测试自动发布pod脚本"

trunk_register_name="ocean"
trunk_register_email="849638313@qq.com"
...
echo "\n ------ 执行 pod 注册 ------ \n"
echo "pod trunk register ${trunk_register_email} ${trunk_register_name} --verbose"
pod trunk register ${trunk_register_email} ${trunk_register_name} --verbose

# 这里等待用户在邮箱中点击确认了再往下执行
echo "确认邮箱已经发送到了您设置的邮箱，请点击确认之后再回到终端'回车'处理:"
read is_confirmed
